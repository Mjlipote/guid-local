...
import tw.edu.ym.lab25.web.guidlocalserver.helper.HttpClientHelper;
...
public class MainControllerTest {
  ...
  public void testCreateSubprimeGuid() throws URISyntaxException, IOException {
    ...
    assertEquals(HttpActionHelper
        .toPost(new URI(RestfulConfig.GUID_LOCAL_SERVER_URL), Action.CREATE, spGuidCreateRequestList, false).getBody(),
        "TEST-Y3XZU2NG");
  ...
  @Test
  public void testBatchSubprimeGuid() throws JsonProcessingException, URISyntaxException {
    ...
    assertEquals(HttpActionHelper
        .toPost(new URI(RestfulConfig.GUID_LOCAL_SERVER_URL), Action.BATCH, spGuidCreateRequestList, true).getBody(),
  ...
  public void testUser() throws URISyntaxException, IOException {
    ...
    HttpClientHelper hch =
        new HttpClientHelper(new URI(RestfulConfig.GUID_LOCAL_SERVER_URL), "admin", "password", Action.USER);
  ...
  public void testExist() throws URISyntaxException, IOException {
    ...
    assertTrue(HttpActionHelper.toGet(new URI(RestfulConfig.GUID_LOCAL_SERVER_URL), Action.EXIST,
    ...
    assertTrue(HttpActionHelper.toGet(new URI(RestfulConfig.GUID_LOCAL_SERVER_URL), Action.EXIST,
        "?hashcode1=xxxxx&hashcode2=yyyyy&hashcode3=zzzzz", true).getBody().equals("false"));

    HttpClientHelper hch =
        new HttpClientHelper(new URI(RestfulConfig.GUID_CENTRAL_SERVER_URL), "admin", "password", Action.EXIST);
