...
public class SetupController {
  ...
  void preProcessData() throws IOException {
    ...
    if (institutePrefixRepo.findByInstitute("生物資料庫測試單位") == null) {
    ...
    if (institutePrefixRepo.findByInstitute("國立陽明大學測試單位") == null) {
    ...
    if (institutePrefixRepo.findByInstitute("使用者測試單位") == null) {
    ...
    if (spGuidRepo.findByHashcode1AndHashcode2AndHashcode3AndPrefix(
